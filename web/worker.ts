// Cloudflare Worker: serves the static site and proxies one thing the browser cannot fetch itself —
// a Piltover Archive deck page (CORS). Allowlisted host, honest User-Agent, short cache.
